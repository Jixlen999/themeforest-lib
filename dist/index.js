...
`;exports.Button=l=>{var{width:a=200,height:h=60,text:s="Button text",disabled:p=!1,onClick:c}=l,g=o(l,["width","height","text","disabled","onClick"]);const{icon:x,fontSize:b,fontWeight:m}=g;return e.createElement(t.ThemeProvider,{theme:i},e.createElement(r,{width:a,height:h,onClick:p?void 0:c,disabled:p,icon:x||null},x&&e.createElement(d,null,x),e.createElement(n,{fontSize:b&&b,fontWeight:m&&m},s)))},exports.RoundButton=r=>{var{size:n=200,text:d="Button text",disabled:s=!1,onClick:p}=r,c=o(r,["size","text","disabled","onClick"]);const{fontSize:g,fontWeight:x}=c;return e.createElement(t.ThemeProvider,{theme:i},e.createElement(h,{width:n,height:n,disabled:s},e.createElement(l,{width:n-.15*n,height:n-.15*n,onClick:s?void 0:p,disabled:s},e.createElement(a,{fontSize:g&&g,fontWeight:x&&x},d))))};
