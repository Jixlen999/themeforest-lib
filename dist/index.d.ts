...
`,n=t.p`
  ...
  overflow: hidden;
`,i=({state:t="enabled",width:i=200,height:p=60,text:h="Button text",onClick:l})=>e.createElement(o,{theme:r},e.createElement(a,{state:t,width:i,height:p,onClick:l},e.createElement(n,null," ",h)));export{i as Button};
